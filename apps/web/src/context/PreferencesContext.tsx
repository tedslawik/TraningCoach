...
export const FEATURES: FeatureDef[] = [
  ...
  { id:'run_technique_ai',       label:'Analiza treningowa AI',          description:'AI analizuje technikę biegu (kadencja, EF) oraz proporcje treningowe S/B/R (koszt ~$0.05/analizę). Widoczna w Dashboardzie.', category:'general', defaultOn:false },
